        ...
        <div className={styles.projects}>
            ...
            <Card render={()=>(
                <>
                    ...
                    <p className={styles.project_description}>This was my first project on my journey of learning Reactjs. This Project was created with the purpose of developing a frontend for E commerce website and implimenting concepts error handling, conditional rendering, custom validity message and React hooks. It has a client side routing. 
